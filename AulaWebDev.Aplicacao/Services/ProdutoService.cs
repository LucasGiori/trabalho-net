...
namespace AulaWebDev.Aplicacao.Services
{
    public class ProdutoService : IProdutoService
    {
        ...
        public ProdutoService(IProdutoRepository produtoRepository, ICategoryRepository categoryRepository,  IMapper mapper)
        {
        ...
        public async Task<ResultService<ProdutoResponseDto>> CriarAsync(ProdutoDto produtoDto)
        {
            ...
            var categoria = await _categoryRepository.FindByIdAsync(produtoDto.CategoriaId);
            if (categoria == null)
